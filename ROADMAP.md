...
- [x] **Phase 9** — `docs/REPORT.md` + `REPORT.pdf`: architecture + diagram, dataset + loading, API docs, design choices & trade-offs, performance report — using real Python/Redis numbers.
